    ...
    public partial class ECommerceDbContext : DbContext
    {
        ...
        private void SeedLuxSalon(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usluga>().HasData(
                ...
                new { Id = 6, Naziv = "Anti-age tretman lica", Opis = "Tretman protiv starenja kože", Cijena = 55m, TrajanjeMinuta = 60, UslugaKategorijaId = (int?)3, Tagovi = "lice,njega,antiage", IsActive = true, CreatedAt = new DateTime(2026, 7, 20, 0, 0, 0, DateTimeKind.Utc), UpdatedAt = (DateTime?)null },
            ...
            modelBuilder.Entity<FrizerUsluga>().HasData(
                ...
                new { Id = 6, FrizerId = 2, UslugaId = 6 },
