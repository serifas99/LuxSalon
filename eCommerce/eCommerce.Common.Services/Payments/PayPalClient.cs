...
namespace eCommerce.Common.Services.Payments
{
    ...
    public class PayPalClient : IPayPalClient
    {
        ...
        public async Task<PayPalOrderResult> KreirajNarudzbuAsync(decimal iznos, string referenca)
        {
            ...
            var body = new
            {
                ...
                {
                    return_url = "https://localhost:7185/Placanje/Success",
                    cancel_url = "https://localhost:7185/Placanje/Cancel",
                    brand_name = "LuxSalon",
                    user_action = "PAY_NOW"
                }
            };
